...
namespace TimeSheetManagementSystem.Data
{
    public class ApplicationDbContext : IdentityDbContext<ApplicationUser>
    {
        ...
        {
            optionsBuilder.UseSqlServer(@"Server=AISYAH\SQLEXPRESS;database=TSM_110717_4;Trusted_Connection=True;MultipleActiveResultSets=True");
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserInfo>()
             .HasIndex(input => input.Email).IsUnique()
             .HasName("UserInfo_Email_UniqueConstraint");
